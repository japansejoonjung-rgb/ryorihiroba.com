...
import { getAuthErrorMessage, loginUser, loginWithGoogle, registerUser } from "@/lib/authService";
...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      handleAuthSuccess("Google 계정으로 로그인되었습니다.");
    } catch (authError) {
      setError(getAuthErrorMessage(authError));
    } finally {
      setSubmitting(false);
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="mt-6 grid gap-5">
              ...
              <button
                ...
                disabled={submitting || !firebaseReady}
                className="inline-flex items-center justify-center gap-2 rounded-full border border-orange-200 px-6 py-3 font-bold text-orange-500 hover:bg-orange-50 disabled:cursor-not-allowed disabled:border-stone-200 disabled:text-stone-400"
              >
                <LogIn size={18} />
                Googleで続ける
              </button>
